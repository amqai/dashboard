...
const FeatureToggleListItem: React.FC<FeatureToggleActionProps> = ({
  organizationId,
  feature,
  enabled,
  onToggle,
...
const FeatureToggleList: React.FC<FeatureToggleModalProps> = ({
  organizationId,
  visible,
}) => {
  ...
  return (
    <>
      {loading ? (
        ...
        <Form labelCol={{ span: 5 }} style={{ maxWidth: 600 }}>
